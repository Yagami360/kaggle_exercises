...
if __name__ == '__main__':
    ...
    X_train, y_train, X_test = load_dataset( args = args, dataset_dir = args.dataset_dir, image_height = args.image_height, image_width = args.image_width, n_channels = args.n_channels, n_classes = args.n_classes, one_hot_encode = False, n_samplings = args.n_samplings )
