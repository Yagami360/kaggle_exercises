    ...
    def objective(trial):
        ...
        if( args.regressor == "logistic" ):
            params = {
                ...
                'C': trial.suggest_loguniform('C', 0.01, 100.0,),          # 一様分布に従う。
            ...
            params = {
                ...
                'C': trial.suggest_loguniform('C', 0.01, 1000.0),
...
if __name__ == '__main__':
    ...
    parser.add_argument("--regressor", choices=["logistic", "knn", "svm", "random_forest", "bagging", "adaboost", "xgboost", "lightgbm", "catboost", "mlp"], default="catboost", help="チューニングするモデル")
